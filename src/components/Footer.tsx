...
export default function Footer() {
  return (
    ...
    >
      ...
      <Container sx={{ textAlign:'center',display:'grid',justifyContent:'center',}} maxWidth="lg">
        ...
        {/* <div className="absolute right-60 top-45">
  ...
  <circle cx="50" cy="50" r="50" fill="url(#redGlow)" />
</svg>
        </div> */}
